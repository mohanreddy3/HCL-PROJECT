...
public class GenderdetectionCNN {

    private static final Logger logger = LoggerFactory.getLogger(GenderdetectionCNN.class);

    private Net genderNet;

    public GenderdetectionCNN() {
        try {
            genderNet = new Net();
            ...
            throw new IllegalStateException("Unable to start GenderdetectionCNN", e);
        }
    }
